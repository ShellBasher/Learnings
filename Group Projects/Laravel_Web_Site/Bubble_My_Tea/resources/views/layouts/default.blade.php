...
<!== header ==>
    <header class="bg-light_pink md:mx-auto" height=150px>
        <div>
            <a href="{{ route('home') }}"><img src="images/logo.png" alt="logo" width="100" id="Logo" class="absolute top-0 right-40"></a>
            
            <a href="{{ route('home') }}"><h1 id="titre" class="text-black text-7xl text-center font-Lobster">Bubble My Tea</h1></br></a>
            ...
            <nav class="container  md:bg-sky-500/50 right-10 flex space-x-20">
                ...
                <a href="{{ route('menu') }}" class="">Notre carte</a></br>
</br>
                <a href="{{ route('about') }}">Notre histoire</a></br>
</br>
                <a href="{{ route('register') }}">Créer mon compte</a></br>
</br>

                <a href="{{ route('bag') }}"><img src="images/cart.png" alt="cart" class="w-10 float-right"></a>
                <a href="{{ route('login') }}" class="w-9 float-right"><img src="images/user.png" alt="user"></a>
            </nav>
        </div>
    </header>
    <main>
