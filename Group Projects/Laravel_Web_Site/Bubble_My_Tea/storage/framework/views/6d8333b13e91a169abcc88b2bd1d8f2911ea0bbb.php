                 ...
                 <div class="menu-group">
                    <div class="menu-item">
                        ...
                        <div class="menu-item-text">
                            ...
                            <button method="POST" class="bouton_ajouter_au_panier" type="button">Ajouter au panier</button>
                        </div> 
                    </div>
                    ...
                    <div class="menu-item">
                        ...
                        <div class="menu-item-text">
                            ...
                            <button class="bouton_ajouter_au_panier" type="button">Ajouter au panier</button>
                        </div> 
                    </div>
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tomfleur/ETNA/BubbleMyTea/group-971066/B_my_tea/resources/views/menu.blade.php ENDPATH**/ ?>